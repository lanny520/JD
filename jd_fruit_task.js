...
[task_local]
#jd免费水果
5 6-22/4 * * * jd_fruit_task.js, tag=东东农场日常任务, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdnc.png, enabled=true
=========================Loon=============================
[Script]
cron "5 6-22/4 * * *" script-path=jd_fruit_task.js,tag=东东农场日常任务
